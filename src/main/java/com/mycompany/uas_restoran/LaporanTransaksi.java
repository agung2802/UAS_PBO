...
public class LaporanTransaksi
    ...
    public final void loadData() {
        ...
        o[2] = r.getString("nama_customer");
        o[3] = r.getString("total_harga");
        o[4] = r.getString("jenis_pembayaran");
        o[5] = r.getString("nama_pegawai");
        o[6] = r.getString("jumlah_bayar");
    ...
    private void tableDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDataMouseClicked
        ...
        DetailTransaksi detail = new DetailTransaksi(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanTransaksi.class.getName()).
